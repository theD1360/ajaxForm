jQuery Submission/validation library
====================================
...
`
             <form method='post' action="verify.php" >
                    ...
                    <br />
                    Hex: <input type="text" data-verify='/^#?([a-f0-9]{6}|[a-f0-9]{3})$/' data-message='this is not a valid hexadecimal color' name="hex" value="#f12ab3" />
                    <br />
